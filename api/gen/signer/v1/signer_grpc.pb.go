...
const (
	...
	BridgeSigner_SignInitial_FullMethodName           = "/signer.v1.BridgeSigner/SignInitial"
)
...
type BridgeSignerClient interface {
	...
	// SignInitial produces the one-time validator EVM-key registration
	// signatures. It does NOT accept a message to sign: the signer rebuilds the
	// two fixed registration messages itself from its own operator address,
	// then signs sha256(sha256(message)).
	SignInitial(ctx context.Context, in *SignInitialRequest, opts ...grpc.CallOption) (*SignInitialResponse, error)
}
...
func (c *bridgeSignerClient) SignInitial(ctx context.Context, in *SignInitialRequest, opts ...grpc.CallOption) (*SignInitialResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignInitialResponse)
	err := c.cc.Invoke(ctx, BridgeSigner_SignInitial_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BridgeSignerServer interface {
	...
	// two fixed registration messages itself from its own operator address,
	// then signs sha256(sha256(message)).
	SignInitial(context.Context, *SignInitialRequest) (*SignInitialResponse, error)
...
func (UnimplementedBridgeSignerServer) SignBridgeCheckpoint(context.Context, *SignBridgeCheckpointRequest) (*SignBridgeCheckpointResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignBridgeCheckpoint not implemented")
}
func (UnimplementedBridgeSignerServer) SignOracleAttestation(context.Context, *SignOracleAttestationRequest) (*SignOracleAttestationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignOracleAttestation not implemented")
}
func (UnimplementedBridgeSignerServer) SignInitial(context.Context, *SignInitialRequest) (*SignInitialResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignInitial not implemented")
}
...
func _BridgeSigner_SignInitial_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignInitialRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BridgeSignerServer).SignInitial(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BridgeSigner_SignInitial_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BridgeSignerServer).SignInitial(ctx, req.(*SignInitialRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BridgeSigner_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SignInitial",
			Handler:    _BridgeSigner_SignInitial_Handler,
		},
	},
