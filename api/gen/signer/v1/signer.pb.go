...
// SignInitialRequest carries the operator (valoper) address the two one-time
// registration messages are built for.
type SignInitialRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// operator_address is the bech32 validator operator address.
...
func (x *SignInitialRequest) Reset() {
	*x = SignInitialRequest{}
	mi := &file_signer_v1_signer_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignInitialRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignInitialRequest) ProtoMessage() {}

func (x *SignInitialRequest) ProtoReflect() protoreflect.Message {
	mi := &file_signer_v1_signer_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignInitialRequest.ProtoReflect.Descriptor instead.
func (*SignInitialRequest) Descriptor() ([]byte, []int) {
	return file_signer_v1_signer_proto_rawDescGZIP(), []int{17}
}

func (x *SignInitialRequest) GetOperatorAddress() string {
	if x != nil {
...
func (x *SignInitialRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
// SignInitialResponse contains the two registration signatures.
type SignInitialResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// sha256(sha256("TellorLayer: Initial bridge signature A for operator <op>")).
	SignatureA []byte `protobuf:"bytes,1,opt,name=signature_a,json=signatureA,proto3" json:"signature_a,omitempty"`
	// sha256(sha256("TellorLayer: Initial bridge signature B for operator <op>")).
	SignatureB    []byte `protobuf:"bytes,2,opt,name=signature_b,json=signatureB,proto3" json:"signature_b,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SignInitialResponse) Reset() {
	*x = SignInitialResponse{}
	mi := &file_signer_v1_signer_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignInitialResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignInitialResponse) ProtoMessage() {}

func (x *SignInitialResponse) ProtoReflect() protoreflect.Message {
	mi := &file_signer_v1_signer_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignInitialResponse.ProtoReflect.Descriptor instead.
func (*SignInitialResponse) Descriptor() ([]byte, []int) {
	return file_signer_v1_signer_proto_rawDescGZIP(), []int{18}
}

func (x *SignInitialResponse) GetSignatureA() []byte {
	if x != nil {
		return x.SignatureA
	}
	return nil
...
func (x *SignInitialResponse) GetSignatureB() []byte {
	if x != nil {
		return x.SignatureB
	}
	return nil
...
const file_signer_v1_signer_proto_rawDesc = "" +
	...
	"\bsnapshot\x18\x02 \x01(\fR\bsnapshot\"^\n" +
	"\x12SignInitialRequest\x12)\n" +
	"\x10operator_address\x18\x01 \x01(\tR\x0foperatorAddress\x12\x1d\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tR\trequestId\"W\n" +
	"\x13SignInitialResponse\x12\x1f\n" +
	"\vsignature_a\x18\x01 \x01(\fR\n" +
	"signatureA\x12\x1f\n" +
	"\vsignature_b\x18\x02 \x01(\fR\n" +
	"signatureB2\xd2\x05\n" +
	"\fBridgeSigner\x127\n" +
	...
	"\x15SignOracleAttestation\x12'.signer.v1.SignOracleAttestationRequest\x1a(.signer.v1.SignOracleAttestationResponse\x12L\n" +
	"\vSignInitial\x12\x1d.signer.v1.SignInitialRequest\x1a\x1e.signer.v1.SignInitialResponseB?Z=github.com/tellor-io/bridge-signer/api/gen/signer/v1;signerv1b\x06proto3"
...
var file_signer_v1_signer_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_signer_v1_signer_proto_goTypes = []any{
	...
	(*SignInitialRequest)(nil),            // 17: signer.v1.SignInitialRequest
	(*SignInitialResponse)(nil),           // 18: signer.v1.SignInitialResponse
}
var file_signer_v1_signer_proto_depIdxs = []int32{
	...
	17, // 9: signer.v1.BridgeSigner.SignInitial:input_type -> signer.v1.SignInitialRequest
	1,  // 10: signer.v1.BridgeSigner.Sign:output_type -> signer.v1.SignResponse
	3,  // 11: signer.v1.BridgeSigner.GetPublicKey:output_type -> signer.v1.GetPublicKeyResponse
	5,  // 12: signer.v1.BridgeSigner.SignRaw:output_type -> signer.v1.SignRawResponse
	7,  // 13: signer.v1.BridgeSigner.GetAddress:output_type -> signer.v1.GetAddressResponse
	9,  // 14: signer.v1.BridgeSigner.SignTx:output_type -> signer.v1.SignTxResponse
	11, // 15: signer.v1.BridgeSigner.GetChainID:output_type -> signer.v1.GetChainIDResponse
	14, // 16: signer.v1.BridgeSigner.SignBridgeCheckpoint:output_type -> signer.v1.SignBridgeCheckpointResponse
	16, // 17: signer.v1.BridgeSigner.SignOracleAttestation:output_type -> signer.v1.SignOracleAttestationResponse
	18, // 18: signer.v1.BridgeSigner.SignInitial:output_type -> signer.v1.SignInitialResponse
